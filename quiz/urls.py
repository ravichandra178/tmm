...
from .views import QuizListView, CategoriesListView,\
    ...
    QuizMarkingDetail, QuizDetailView, QuizTake, index, login_user, logout_user, testView, compiler
...
urlpatterns = [         url(regex=r'^$', view=index, name='index'),
                        ...
                        url(regex=r'^compiler/$', view=compiler, name='compiler'),
                       url(regex=r'^quizzes/$',
